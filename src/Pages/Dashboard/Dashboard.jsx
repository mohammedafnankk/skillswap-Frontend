            ...
            <div className="max-w-3xl">
              ...
              {user.role === "Mentor" ? (
                <p className="mb-3 text-[17px]">
                  Empower Learners Through Real-Time Mentoring As a mentor, you
                  play a key role in guiding students through their programming
                  journey. Our platform connects you directly with learners
                  seeking help, allowing you to share your expertise, answer
                  questions in real time, and provide personalized support. Help
                  students overcome challenges, build real skills, and grow
                  their confidence — all through interactive chat sessions.
                </p>
              ) : user.role === "Student" ? (
                <p className="mb-3 text-[17px]">
                  Connect with Experienced Mentors and Accelerate Your Learning
                  Our platform bridges the gap between students and expert
                  mentors through real-time chat-based guidance. Whether you're
                  stuck on a coding problem or exploring new technologies,
                  mentors are here to support you with personalized
                  explanations, hands-on help, and career advice — helping you
              ...
              {user.role === "Mentor" ? (
                ...
                <div className="flex gap-4">
                  <a
                    href="#mentors"
                    className="text-sm px-[20px] py-[10px] rounded-md bg-white hover:bg-gray-100 text-purple-700 font-medium"
                  >
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Software development, web, mobile, and more
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      <li>
                        Intro to ES6+ features (arrow functions, spread,
                        destructuring)
                      </li>
                    </div>
                  </div>
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Teaching, learning, and academic skills
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      <li>
                        Deployment with platforms like Render, Vercel, Netlify
                      </li>
                    </div>
                  </div>
                  {/* <div className="cursor-pointer flex justify-between items-center hover:bg-[#f1f5f9] px-[20px] py-[10px] rounded-[8px] text-sm">
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Teaching, learning, and academic skills
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      <li>
                        How to handle inappropriate or off-topic questions
                      </li>
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Teaching, learning, and academic skills
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      <li>
                        Curriculum outline: HTML → CSS → JS → React → Backend
                      </li>
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Teaching, learning, and academic skills
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      <li>
                        How to respond to “I don’t understand” effectively
                      </li>
                ...
                <div className="p-6 rounded-lg border hover:shadow-lg transition-shadow max-sm:p-5 bg-white">
                  ...
                  Teaching, learning, and academic skills
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      <li>
                        Free tools for diagrams, code sharing (CodeSandbox,
                        Replit)
                      </li>
            ...
            <section>
              <div>
                <div>
                  ...
                  <h2 className="text-2xl font-semibold pb-3">
                    Level Up Your Coding Skills — One Chat at a Time
                  </h2>
                </div>
              </div>
              <div className="rounded-md shadow-md bg-white px-6 py-3">
                <p className="text-md text-gray-400">
                  ...
                  Our platform delivers programming knowledge through
                  interactive chats. Whether you're a beginner or growing your
                  stack, get hands-on help and learn in a way that feels natural
                  and fast.
                </p>
              </div>
            </section>
                ...
                <div>
                  <section id="mentors">
                    <div className="flex justify-between mb-6 items-center max-sm:mb-3">
                      ...
                      <button
                        onClick={() => navigate(`/all-mentors/${user._id}`)}
                        className="rounded-md px-[20px] py-[10px] text-purple-700 hover:bg-gray-100 text-sm"
                      >
                        View all <i class="fa-solid fa-arrow-right pl-2"></i>
                      </button>
                    </div>
                    <div className="grid grid-cols-3 gap-5 max-lg:grid-cols-2 max-md:grid-cols-1">
                      {mentor.map((m, i) => (
                        <div
                          key={i}
                          className="rounded-lg border shadow-sm hover:shadow-md transition-shadow bg-white"
                        >
                          <div className="p-6 max-sm:p-3">
                            ...
                            <div className=" mt-4 grid grid-cols-3 gap-2">
                              {m.skills.map((s, i) => (
                                <div
                                  key={i}
                                  className="inlile-flex items-center rounded-full px-2.5 py-0.5 text-xs font-[550] max-sm:font-medium bg-[#f1f5f9] "
                                >
                                  {s}
                                </div>
                              ))}
                          ...
                          <div className="flex items-center p-6 pt-0">
                            <Link
                              to={`/mentor/${m._id}/${user._id}`}
                              className=" text-white inline-flex items-center justify-center rounded-md text-sm font-[550] max-sm:font-medium bg-purple-600 hover:bg-purple-700 px-4 py-2 w-full"
                            >
                              View Profile
                            </Link>
                          </div>
                    ...
                    <div className="flex items-center justify-between gap-6 max-sm:flex-col">
                      <div>
                        ...
                        <p className="text-[#94a3b8] max-sm:text-sm">
                          Become a mentor and help others grow while expanding
                          your network.
                        </p>
                      </div>
                      <button className="text-sm rounded-md px-8 bg-purple-600 hover:bg-purple-700 text-white py-4">
                        ...
                        <i class="fa-solid fa-bolt pl-2"></i>
                      </button>
                    </div>
                  </section>
                </div>
