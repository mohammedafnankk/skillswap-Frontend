...
function Chat() {
  ...
  const messageSelecte = async (id) => {
    console.log("clicked");
    setIsSelected(prev => prev === false ? true : false)
    setIsSelectedLoading(true)
    //  console.log(isSelectedLoading,"sele")
      ...
      <div className="py-6 px-4 ml-[224px] max-lg:ml-0 pt-24 bg-gray-50 h-screen">
        {isUserLoading ?
          ...
          <div>
            ...
            <div className="grid grid-cols-3 rounded-lg border bg-white max-sm:block max-sm:h-scree min-h-[400px]">
              <div
              ...
              <div className="border-b px-4 py-2 ">
                ...
                {isMentorLoading ?
                  <div className=" p-1">
                    ...
                    <div class=" border rounded-md p-4 max-w-sm w-full mx-auto mb-1">
                    ...
                    <div class=" border mb-1 rounded-md p-4 max-w-sm w-full mx-auto">
                      <div class="animate-pulse flex space-x-4">
                        <div class="rounded-full bg-gray-300 h-10 w-10"></div>
                        <div class="flex-1 space-y-3 py-1">
                          <div class="h-2 bg-gray-300 rounded"></div>
                  ...
                  <div className="overflow-y-auto h-64 max-sm:h-[700px] p-1">
                    {mentors
                      .filter((mentor) => {
                        if (searchUser === "") {
                          return mentor;
                      ...
                      .map((mentor, i) => (
                        <div key={i}>
                          <button
                            ...
                            className={`w-full flex items-start p-1.5 rounded-md border mb-1 flex items-center ${mentor._id === selectedUser._id
                          ...
                          >
                            ...
                            <div className="flex-1 pl-2">
                              <div className="flex justify-between items-baseline">
                                ...
                                <span
                                  className={`text-sm ${mentor._id === selectedUser._id
                                    ? "hidden max-sm:block"
                                    : "block"
                                    }`}
                                >
                            ...
                            {isSelectedLoading ?
                              <p className="h-4 w-4 border-purple-700 border-2 border-t-transparent rounded-full animate-spin"></p>
                              :
                              <div
                                className={`pl-2 ${mentor._id === selectedUser._id
                                  ? "block max-sm:hidden"
                                  : "hidden"
                                  }`}
                              >
              ...
              {isSelected === true ? (
                  ...
                  <div className="flex-1 overflow-y-auto space-y-6 p-4 max-h-60 max-sm:max-h-[500px] max-sm:space-y-3 ">
                    {messages.map((m, index) => (
                      <div
                        ref={bottomRef}
                        key={index}
                        className={` ${m.senderId === currentUser._id
                          ? "text-right "
                          : "text-left"
                          }`}
                      >
                        <span
                          className={`max-w-[80%] inline-flex flex-col ${m.senderId === currentUser._id
                        ...
                        >
                          {m.text}
                          <span
                            className={`text-xs max-sm:text-[9px] ${m.senderId === currentUser._id
                              ? "text-gray-200"
                              : "text-gray-500"
                              }`}
                          >
                ...
                <div className="flex flex-1 items-cente justify-center col-start-2 col-end-4 max-sm:hidden">
                  {isSelectedLoading ?
                    <div class=" rounded-md p-4 max-w-sm w-full mx-auto pt-[8%] ">
                      <div class="animate-pulse flex flex-col space-x-4 items-center ">
                        <div class="rounded-full bg-gray-300 h-20 w-20 mb-2"></div>
                        <div class="flex-1 space-y-6 py-1 w-[150%]">
                          <div class="h-4 bg-gray-300 rounded"></div>
